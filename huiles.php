...
<head>
    ...
    <link rel="stylesheet" href="css/huiles.css">
...
<body id="body">
  ...
  ?>
   ...
   <div class="filter mt-5 d-flex justify-content-center">
   <div class="search" > <input type="text" placeholder="chercher"> <i class="bi bi-search"></i> </div>
    <div class="dropdown">
      ...
      <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
        ...
        <!--elmnt-->
        <div id="p1" class="card mx-3 shadow bg-body rounded" style="width: 18rem;">
          <img src="imgs/CBD.jpg" class="card-img-top" alt="...">
          <div class="card-body mx-1">
            <h5 class="card-title">huile shurtan</h5>
            <div class="stars mb-3">
        ...
        <!--elmnt-->
        <div id="p1" class="card mx-3 shadow bg-body rounded" style="width: 18rem;">
          <img src="imgs/grn.jpg" class="card-img-top" alt="...">
          <div class="card-body mx-1">
            <h5 class="card-title">huile shurtan</h5>
            <div class="stars mb-3">
             ...
             <!--<div class="products d-flex justify-content-center mt-5 mb-5" data-aos="fadeInUp">
                 <div id="p1" class="card mx-3 shadow bg-body rounded" style="width: 18rem;">
                     ...
                     <div class="card-body mx-1">
                       ...
                       <h5>11£</h5>
                        ...
                        <i class="bi bi-cart-plus"></i>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           
                         ...
                         <div id="p2" class="card mx-3 shadow bg-body rounded" style="width: 18rem;">
                          <img src="imgs/mirah.jpg" class="card-img-top" alt="...">
                          <div class="card-body mx-1">
                   ...
                   <div id="p1" class="card mx-3 shadow bg-body rounded" style="width: 18rem;">
                    <img src="imgs/massage2.jpg" class="card-img-top" alt="...">
                    <div class="card-body mx-1">
                      <h5 class="card-title">huile massage</h5>
                      <div class="stars mb-3">
